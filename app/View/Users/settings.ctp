<div class="row">
  ...
  <div class="medium-10 large-centered columns">
    ...
    <div class="row">
      ...
      <?= $this->Form->input('username', array('disabled' => true)); ?>
      </div>
      <div class="large-6 columns">
      <?= $this->Form->input('password', array('placeholder' => 'Password')); ?>
      </div>
      <div class="large-6 columns">
      <?= $this->Form->input('email', array('type' => 'email', 'placeholder' => 'Email Address')); ?>
      </div>
      <div class="large-6 columns">
    ...
    <div class="row">
      ...
      <?= $this->Form->end(array('label' => __('Submit'), 'class' => 'button [tiny small large radius round]')); ?>
      </div>
    </div>
  </div>
</div>